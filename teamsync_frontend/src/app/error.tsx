...
export default function GlobalError({
  ...
  // Render regular nodes only (no html/body) and wire Try again to explicitly call reset()
  return (
    <>
      <section
        className="ts-card ts-card-hover p-8 text-center bg-gradient-to-b from-blue-500/10 to-gray-50 border border-blue-100 app-container py-16"
        role="alert"
        aria-live="assertive"
      >
